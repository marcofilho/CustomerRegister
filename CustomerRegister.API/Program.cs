...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CustomerRegister.API", Version = "v1" });
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CustomerRegister.API v1"));
